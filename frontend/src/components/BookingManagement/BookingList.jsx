...
//       try {
//         const response = await fetch("https://backend-c469.onrender.com/bookings/getall");
//         if (!response.ok) {
...
//     if (window.confirm("Are you sure you want to delete this booking?")) {
//       try {
//         const response = await fetch(`https://backend-c469.onrender.com/bookings/delete/${id}`, {
//           method: "DELETE",
//         });
//         if (!response.ok) {
...
//   const handleSaveUpdate = async (updatedBooking) => {
//     try {
//       const response = await fetch(`https://backend-c469.onrender.com/bookings/update/${updatedBooking._id}`, {
//         method: "PUT",
//         headers: {
